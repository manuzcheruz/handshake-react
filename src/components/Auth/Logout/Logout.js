    ...
    return (
        <div className="section">
            <div className="container">
                <div className="illustration-sad"  style={{zIndex: '1', position: 'absolute', marginTop: '800px'}}>
                    <Sad height={300} />
                </div>
                <div className="logout-wrapper" style={{zIndex: '2', position: 'absolute', marginTop: '300px'}}>
