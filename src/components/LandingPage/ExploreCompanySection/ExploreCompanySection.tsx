...
/**
 * interfacing the data to be recieved by ExploreCompanySection component
 */
...
/**
 * simulating the data to be recieved from the server
 */
...
function ExploreCompanySection(): JSX.Element {
    return (
