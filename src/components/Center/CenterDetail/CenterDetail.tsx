...
/**
 * interfacing the properties of the news object to be recieved
 */
export interface PropsNews {
    title: string;
    time: string;
    image: any;
    google?: any; //will remove this after I know how to work with the main props interface
    onCenterDetailFetch?: any;
    centerFromReg?: any;
    centerFromFetch?: any;
}

/**
 * sample news json object to be recieved from the server
 */
const news: PropsNews[] = [
    {
...
/**
 * this componet is used to render the detail page of centers
 * @param props 
 * @returns 
 */
function CenterDetail(props: any) {
...
// export interface StateCenterDetail {
//     centerFromReg: string;
//     centerFromFetch: string;
// }
